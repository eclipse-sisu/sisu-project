...
public class ObjectWithFieldsConverter extends AbstractConfigurationConverter {
    ...
    private Object fromConstructorTakingString(
            final Class<?> type, String value, ComponentConfigurationException precedingException)
            throws ComponentConfigurationException {
        try {
            try {
            ...
            ComponentConfigurationException cce = new ComponentConfigurationException(
                    "Cannot create instance of " + type + " with public constructor having a single String argument",
                    e);
            if (precedingException != null) {
