...
public class ParameterizedCollectionTest extends TestCase {
    ...
    public void testParameterizedArray() throws Exception {
        ...
        Map<String, Map<String, List<Boolean>>>[] expectedArray = new Map[] {
            singletonMap("a", singletonMap("x", asList(true, false))),
    ...
    protected void configure(final Object component, final String xml) throws Exception {
