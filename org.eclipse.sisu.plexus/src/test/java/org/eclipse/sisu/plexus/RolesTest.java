...
public class RolesTest {
    ...
    public void testMissingComponentExceptions() {
        assertThrows(ProvisionException.class, () -> Roles.throwMissingComponentException(STRING_LITERAL, null));
        assertThrows(ProvisionException.class, () -> Roles.throwMissingComponentException(STRING_LITERAL, "foo"));
    }
