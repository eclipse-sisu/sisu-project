...
import static org.eclipse.sisu.peaberry.eclipse.EclipseRegistry.eclipseRegistry;
import static org.eclipse.sisu.peaberry.Peaberry.osgiModule;
 ...
 * the {@code org.eclipse.sisu.peaberry.eclipse.modules} extension for {@link Module}s
 ...
 *         allowMultiple="true"
 *         icon="icons/sample2.gif"
 *         class="org.eclipse.sisu.peaberry.eclipse.GuiceExtensionFactory:example.ViewImpl"
 *         id="example.view" /{@literal >}
 * {@literal <}/extension{@literal >}
 * {@literal <}extension point="org.eclipse.sisu.peaberry.eclipse.modules"{@literal >}
 ...
 *         allowMultiple="true"
 *         icon="icons/sample2.gif"
 *         class="org.eclipse.sisu.peaberry.eclipse.GuiceExtensionFactory"
 ...
 *         allowMultiple="true"
 *         icon="icons/sample2.gif"
 *         class="org.eclipse.sisu.peaberry.eclipse.GuiceExtensionFactory:org.eclipse.ui.IViewPart"
 *         id="example.view" /{@literal >}
 * {@literal <}/extension{@literal >}
 * {@literal <}extension point="org.eclipse.sisu.peaberry.eclipse.modules"{@literal >}
 *   {@literal <}module class="example.ViewModule" /{@literal >}
...
public final class GuiceExtensionFactory
  ...
  public static final String POINT_ID = "org.eclipse.sisu.peaberry.eclipse.modules";
